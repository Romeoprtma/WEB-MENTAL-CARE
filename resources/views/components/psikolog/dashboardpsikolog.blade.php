{{-- resources/views/components/psikolog/dashboardpsikolog.blade.php --}}
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 mb-6">
                <div class="flex justify-between items-start">
                    ...
                    <div class="flex items-center space-x-6">
                        <img class="w-24 h-24 rounded-full object-cover" src="https://ui-avatars.com/api/?name=Dr+Clara+Hartono&background=6366f1&color=fff&size=256" alt="Foto Psikolog">
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900">{{ Auth::user()->name }}</h2>
                            <p class="text-sm text-gray-600 mt-1">Psikolog Klinis | Spesialis Trauma & Kesehatan Mental Remaja</p>
                            <div class="mt-3 space-y-1 text-sm text-gray-700">
                                <p><strong>Pengalaman:</strong> 8 tahun</p>
                                <p><strong>Jadwal Konseling:</strong> Senin - Jumat, 09:00 - 17:00</p>
                                <p><strong>Email:</strong> clara.hartono@example.com</p>
                            </div>
                        </div>
                    </div>
                    <!-- Tombol Edit -->
                    <button class="flex items-center bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium px-4 py-2 rounded-lg">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.232 5.232l3.536 3.536M9 13l6.732-6.732a2 2 0 012.828 0l.172.172a2 2 0 010 2.828L12 17H9v-3z"/>
                        </svg>
                        Edit Profil
                    </button>
                </div>
