            ...
            <table class="w-full border-collapse border border-gray-200 rounded-lg overflow-hidden shadow-md">
                <thead class="bg-[#756AB6] text-white">
                    <tr>
                        ...
                        <th class="text-center px-6 py-3 font-semibold uppercase tracking-wider">Audio</th>
                        <th class="text-center px-6 py-3 font-semibold uppercase tracking-wider">Title</th>
                        <th class="text-center px-6 py-3 font-semibold uppercase tracking-wider">Duration</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-100 transition-all">
                        ...
                        <td class="text-center px-6 py-4 text-gray-700">{{ $item->duration }}</td>
                        <td class="text-center px-6 py-4 text-gray-700">
                            ...
                            <form action="{{ route('kelolaMeditasi.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
                                @csrf
                                @method('DELETE')
