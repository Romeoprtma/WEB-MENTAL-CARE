...
<button id="chatbot-toggle" class="bg-white text-[#756AB6] text-xl p-3 rounded-full shadow-xl border border-[#756AB6] hover:bg-[#f0f0f0] focus:outline-none">
    ...
    <!-- Chat Window -->
    <div id="chat-window" class="hidden mt-2 w-80 h-[500px] bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden flex flex-col transition-all duration-300">
    
    <!-- Header -->
    <div class="p-4 border-b bg-[#756AB6] text-white font-bold">MentalCare Bot</div>

    <!-- Messages Area -->
    <div id="chat-messages" class="flex-1 p-4 overflow-y-auto space-y-3 bg-gray-100 dark:bg-gray-700 text-sm"></div>
    ...
    <form id="chat-form" class="flex border-t bg-white dark:bg-gray-800">
        ...
        type="submit"
        id="chat-submit"
        class="bg-[#756AB6] text-white px-4 transition-opacity duration-200"
        >
        Kirim
        </button>
    </form>
